...
ENDERECO_FIXO = "Rua Heitor S. de França, 396 CJ 1301"
INSTA_FIXO = "@naturevittaoficial"
ZAP_FIXO = "41 99987-5384"
NOME_TERAPEUTA_FIXO = "Ieda Tissiani Urnau"
...
def gerar_pdf(texto_analise, dados_usuario, nome_terapeuta, info_rodape):
    ...
    pdf.cell(0, 8, txt="Terapeuta Integrativa", ln=True, align='R')
        ...
        with st.spinner("Analisando dados com IA..."):
            try:
                ...
                Você é um(a) Terapeuta Integrativo(a) Sênior, com vasta experiência prática em:
                    ...
                    ## 7) Gotas de Sabedoria
                    Uma dica especial e inédita de aromaterapia para o dia.

                    ## 8) Nota sobre Biorressonância e Autocura
